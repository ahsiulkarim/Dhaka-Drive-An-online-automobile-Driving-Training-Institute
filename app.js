/*document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('dashboard')) {
        ...
        const renderMyCourses = () => {
            ...
            const statusLevels = { 'Requested': 10, 'Awaiting Payment': 30, 'Payment Submitted': 50, 'Awaiting Cash Payment': 50, 'Approved': 70, 'Completed': 100 };
            ...
            if (hasApprovedCourse) {
                container.innerHTML = `
                    <div class="material-item">
                        <a href="materials/traffic-signs.pdf" download="DhakaDrive-Traffic-Signs.pdf">BRTA Traffic Signs PDF</a>
                    </div>
                    <div class="material-item">
                        <a href="materials/vehicle-checklist.pdf" download="DhakaDrive-Vehicle-Checklist.pdf">Pre-Drive Vehicle Checklist</a>
                    </div>
                    <div class="material-item">
                        <a href="materials/brta-guide.pdf" download="DhakaDrive-BRTA-Guide.pdf">Guide to BRTA Written Test</a>
                    </div>
                `;
            } else {
